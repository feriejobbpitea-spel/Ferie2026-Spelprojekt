...
**Kubbers** är ett 2D pixel art fighting spel utvecklat under ett tre veckor långt feriearbete sommaren 2026, arrangerat av **Piteå Kommun** och utfört på **Kaleido (period 1)**.
...
- **Audacity**  
  Användes för att ljudinspelning för voicelines och ljudeffekter.
...
```bash
git clone https://github.com/feriejobbpitea-spel/Ferie2026-Spelprojekt.git
